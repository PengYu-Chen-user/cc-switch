...
### Der All-in-One-Manager für Claude Code, Claude Desktop, Codex, Gemini CLI, Grok Build, OpenCode, OpenClaw, Hermes Agent, Kimi Code CLI & DeepSeek Harness

> **Dieser Fork** ergänzt den Upstream CC Switch um erstklassige Unterstützung für **Kimi Code CLI** (`kimicode`, Moonshot AI) und **DeepSeek Harness** (`dsh`, DeepSeek AI).
