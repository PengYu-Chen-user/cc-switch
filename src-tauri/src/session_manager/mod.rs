...
use providers::{claude, codex, dsh, gemini, grokbuild, hermes, kimicode, openclaw, opencode, pi};
...
pub fn scan_sessions() -> Vec<SessionMeta> {
    let (r1, r2, r3, r4, r5, r6, r7, r8, r9, r10) = std::thread::scope(|s| {
        ...
        let h9 = s.spawn(kimicode::scan_sessions);
        let h10 = s.spawn(dsh::scan_sessions);
        (
